<script lang="ts">
	...
	let { builds } = data
	let version = $state(Object.keys(builds).at(-2))
...
<main class="main">
	...
	<div class="body">
		...
		<p>
			Perhaps Microsoft are dragging their feet on supporting Apple Silicon (I mean they definitely are) or
			perhaps they are taking their time to make an M1 compatible version super awesome 😏 whatever the case
			it's taking too long.
		</p>
		<p>
			I'm here to bring you some good news though there is an M1 version of Teams in the works over at
			Microsoft. It's experimental but if like me you have used the Rosetta version you'll take whatever you can
			get.
		</p>
		<p>
			Yours,<br />
...
<aside class="aside">
	...
	<a class="button" href={builds[version].href} download onclick={() => ($history = builds[version].number)}
		>Download</a
	>
